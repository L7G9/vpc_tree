...
class TestSubnetTree:
    def test_generate(self, subnets, instances):
        ...
        expected = [
            ...
            "│  └──Instances:",
            "│     ├──i-01 : instance-01 : ami-1234 : t2.micro : running : 10.0.1.5",
            "│     │  └──SecurityGroups:",
            "│     │     └──sg-01",
            "│     └──i-02 : instance-02 : ami-1234 : t2.micro : running : 10.0.1.6",
            "│        └──SecurityGroups:",
            "│           └──sg-01",
            "├──sn-02 : subnet-02 : eu-west-2b : 10.0.2.0/24",
            "│  └──Instances:",
            "│     └──i-03 : instance-03 : ami-1234 : t2.micro : running : 10.0.2.7",
            "│        └──SecurityGroups:",
            "│           └──sg-02",
